...
uv run --no-sync python -m viclip_ot.train \
  ...
  --wandb_name viclip_direct_graph_kl_graph_to_student \
  ...
  --criterion hybrid_clip_direct_graph_kl_loss \
  --direct_graph_kl_loss_direction graph_to_student \
  --sim_combine_method cross_modality \
  --hybrid_clip_direct_graph_kl_loss_clip_loss_lambda 0.1
